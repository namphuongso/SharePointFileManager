...
const vi: Messages = {
  ...
  noDeletePermission: "Bạn không có quyền xóa mục này",
  ...
  deleteConfirmTitle: "Xóa mục này?",
  deleteConfirmBody: 'Bạn có chắc muốn xóa "{name}"?',
  deleting: "Đang xóa…",
...
const en: Messages = {
  ...
  noDeletePermission: "You don't have permission to delete this item",
  ...
  deleteError: "Cannot delete this item",
